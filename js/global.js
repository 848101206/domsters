...
function isFilled(fiels){
  return (field.value.length > 1 && fiels.valeue != field.placeholder);
}
...
function prepareForms() {
  for(var i =0; i<document.forms.length;i++){
    ...
    thisform.onsubmit = function(){
      ...
      if(subminFormWithAjac(this,article)) return false;
      return true;
    }
  }
}
